        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-center">
            ...
            <address className="flex justify-center space-x-8 pb-4">
              <a
                href="https://github.com/KTK69"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white text-4xl hover:scale-110 transition-transform mirror"
                aria-label="Tanveer Krishna Kristam on GitHub"
              >
                <FaGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/tanveer-krishna-kristam/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white text-4xl hover:scale-110 transition-transform mirror"
                aria-label="Tanveer Krishna Kristam on Linkedin"
              >
                <FaLinkedinIn />
              </a>
              <a
                href="mailto:tanveerkrishna@gmail.com"
                className="text-white text-4xl hover:scale-110 transition-transform mirror"
                aria-label="Tanveer Krishna Kristam on Email"
              >
                <FaEnvelope />
              </a>
            </address>
